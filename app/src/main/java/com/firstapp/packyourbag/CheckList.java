package com.firstapp.packyourbag;
...
import com.firstapp.packyourbag.Adapter.CheckListAdapter;
import com.firstapp.packyourbag.Data.AppData;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.btnDeleteDefault:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Are you Sure?\n\nAs this would delete the data provided by (Pack Your Bag) while installing.")
            ...
            case R.id.btnReset:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Are you Sure?\n\nAs this would load the default data provided by (Pack Your Bag)" +
